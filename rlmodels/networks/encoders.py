...
class MLPEncoder(keras.layers.Layer):
    def __init__(self, input_shape, hidden_units):
        ...
        setattr(self, name, keras.layers.Dense(
            hidden_units[0], input_shape=input_shape, activation='relu'))
...
class CNNEncoder(keras.layers.Layer):
    def __init__(self, input_shape, filters):
        ...
        setattr(self, conv_name, keras.layers.Conv2D(
            filters[0], input_shape=input_shape, activation='relu'))
